(function(t) {
  function e(e) {
    for (
      var n, r, s = e[0], c = e[1], l = e[2], d = 0, b = [];
      d < s.length;
      d++
    )
      (r = s[d]),
  ...
  cd49: function(t, e, a) {
    ...
    var n = a("2b0e"),
      i = function() {
        ...
        return a(
          ...
          [
                  ...
                  [
                    a(
                      ...
                      [
                        ...
                        a(
                          "action-button",
                          { attrs: { disabled: "", label: "load from url" } },
                          [
                            a("i", {
            ...
            a("input", {
              staticStyle: { position: "absolute", visibility: "hidden" },
      ...
      y = (function(t) {
        function e() {
          return (
            Object(c["a"])(this, e),
            Object(u["a"])(this, Object(d["a"])(e).apply(this, arguments))
          );
        }
        return (
          Object(b["a"])(e, t),
    ...
    f["a"]([Object(p["b"])({ required: !0 })], y.prototype, "value", void 0),
      f["a"]([Object(p["b"])({ required: !0 })], y.prototype, "menu", void 0),
      (y = f["a"]([Object(p["a"])({ name: "Ribbon" })], y));
    var m = y,
      j = m,
      O = (a("8db5"), a("2877")),
      g = Object(O["a"])(j, v, h, !1, null, "7632c134", null),
      x = g.exports,
      _ = function() {
        var t = this,
          e = t.$createElement,
    ...
    f["a"]([Object(p["b"])()], k.prototype, "label", void 0),
      f["a"]([Object(p["b"])({ default: !0 })], k.prototype, "grid", void 0),
      (k = f["a"]([Object(p["a"])({ name: "ControlBox" })], k));
    var w = k,
      S = w,
      $ = (a("6b52"), Object(O["a"])(S, _, C, !1, null, "2b189682", null)),
      I = $.exports,
      T = function() {
        var t = this,
          e = t.$createElement,
    ...
    f["a"]([Object(p["b"])({ required: !0 })], A.prototype, "value", void 0),
      (A = f["a"]([Object(p["a"])({ name: "Editor" })], A));
    var N = A,
      q = N,
      E = (a("cc5c"), Object(O["a"])(q, T, V, !1, null, null, null)),
      F = E.exports,
      P = function() {
        var t = this,
          e = t.$createElement,
      ...
      J = function() {
        var t = this,
          e = t.$createElement,
          a = t._self._c || e;
        return a("div", { staticClass: "object-viewer" }, [
          t.name
            ? a(
                "span",
                {
                  ...
                  on: {
                    dblclick: function(e) {
                      return t.copyNameToClipboard();
                    },
                    click: function(e) {
                      return t.copyValueToClipboard();
                    }
                  }
                },
                [t._v(t._s(t.name) + ":")]
          ...
          t.isObject
            ? a(
                "div",
                { staticClass: "props", class: { open: t.open } },
                [
                  t.expandable
                    ? a("i", {
                        class: "icon fa fa-" + (t.open ? "minus" : "plus"),
                        on: {
                          click: function(e) {
                            t.open = !t.open;
                          }
        ...
        return (
          ...
          Object(l["a"])(e, [
            ...
            },
            {
              ...
              value: function() {
                navigator.clipboard && navigator.clipboard.writeText(this.name);
              }
            },
            {
              key: "copyValueToClipboard",
              value: function() {
                navigator.clipboard &&
                  navigator.clipboard.writeText(
                    JSON.stringify(this.objectValue)
                  );
              }
            },
            {
            ...
            },
            {
              key: "isObject",
              get: function() {
                return "object" === Object(R["a"])(this.value);
              }
            },
            {
              key: "expandable",
    ...
    f["a"]([Object(p["b"])()], H.prototype, "value", void 0),
      f["a"]([Object(p["b"])()], H.prototype, "name", void 0),
      f["a"]([Object(p["b"])()], H.prototype, "isOpen", void 0),
      (H = f["a"]([Object(p["a"])({ name: "ObjectViewer" })], H));
    var L = H,
      D = L,
      G = (a("b7ef"), Object(O["a"])(D, J, B, !1, null, "554fce00", null)),
      z = G.exports,
      U = (function(t) {
        function e() {
          return (
    ...
    f["a"]([Object(p["b"])()], U.prototype, "value", void 0),
      (U = f["a"](
        [Object(p["a"])({ name: "viewer", components: { ObjectViewer: z } })],
        U
      ));
    var W = U,
      K = W,
      Q = (a("c975"), Object(O["a"])(K, P, M, !1, null, "ecbc2146", null)),
      X = Q.exports,
      Y = function() {
        var t = this,
          e = t.$createElement,
    ...
    f["a"]([Object(p["b"])()], at.prototype, "label", void 0),
      f["a"](
      ...
      (at = f["a"]([Object(p["a"])({ name: "ActionButton" })], at));
    var nt = at,
      it = nt,
      ot = (a("c1eb"), Object(O["a"])(it, tt, et, !1, null, "cb93cbbc", null)),
      rt = ot.exports,
      st = (function(t) {
        function e() {
          return (
    ...
    f["a"]([Object(p["b"])({ required: !0 })], st.prototype, "value", void 0),
      (st = f["a"](
        [
          Object(p["a"])({
            name: "ActionGroup",
            components: { ActionButton: rt }
          })
        ],
        st
      ));
    var ct = st,
      lt = ct,
      ut = (a("cfc7"), Object(O["a"])(lt, Y, Z, !1, null, "252226b0", null)),
      dt = ut.exports,
      bt = (function(t) {
        function e() {
          var t;
          return (
            ...
            (t.history = [
              { name: "redo", disabled: !0 },
              { name: "undo", disabled: !0 }
            ]),
            (t.data =
        ...
        return (
          ...
          Object(l["a"])(e, [
            ...
            },
            {
              ...
              value: function(t) {
                if (
                  ((this.historyChanging = !0),
                  "undo" === t && this.historyItems[this.historyIndex - 1])
                ) {
                  var e = this.historyItems[--this.historyIndex];
                  e && (this.data = e);
                } else if (
                  "redo" === t &&
                  this.historyItems[this.historyIndex + 1]
                ) {
                  var a = this.historyItems[++this.historyIndex];
                  a && (this.data = a);
                }
                this.historyChanging = !1;
              }
            },
            {
              key: "format",
            ...
            },
            {
              key: "selectFile",
              value: function() {
                var t = document.getElementById("file_input");
                t && t.click();
              }
            },
            {
            ...
            },
            {
              key: "onChange",
              value: function(t, e) {
                this.historyChanging ||
                  (this.historyIndex++,
                  (this.historyItems = [].concat(
                    Object(r["a"])(this.historyItems),
                    [e]
                  )));
              }
            }
    ...
    var ft = bt,
      pt = ft,
      vt = (a("5da0"), Object(O["a"])(pt, i, o, !1, null, "4cb97ee0", null)),
      ht = vt.exports,
      yt = a("9483");
    Object(yt["a"])("".concat("/OpenFork/", "service-worker.js"), {
      ready: function() {
        console.log(
...
//# sourceMappingURL=app.4dd91544.js.map
